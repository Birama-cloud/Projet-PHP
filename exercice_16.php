...
<head>
    ...
    <title>Transformation de Chaînes de Caractères</title>
...
<body>
    ...
    <div class="main-content">
        <div class="typewriter">
            <h1 class="typewriter-text">Transformation des Chaînes de Caractères</h1>
        </div>
        <center>
            <form method="post" action="">
                <fieldset>
                    <legend>Entrez les chaînes de caractères séparées par des virgules</legend>
                    <label for="strings">Chaînes :</label>
                    <input type="text" id="strings" name="strings" placeholder="Exemple : Bonjour,HELLO,TeXtE" required>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                capitalizeArrayElements($strings);
