...
<body class="immo">
    <header class="header-4">
        <nav class="header-nav">
            ...
            <a href="vendre.php" id="vendre" class="active">Vendre</a>
            <a href="louer.php" id="louer">Louer</a>
    ...
    <section class="bienvenue">
        ...
        <button class="vendre" onclick="openForm('sellForm')">Vendre</button>
        <button class="achat"><a href="acheter.php" style="text-decoration:none;color:white;">Buy Now</a></button>
    </section>
    <section id="articles-sell">
        <center style="color:white;font-size:40px; background-color:rgb(0, 0, 0,.5);">~ Vendez votre bien immobilier ~</center>
        <center style="color:white;background-color:rgb(0, 0, 0,.5);"><form id="house-form">
